...
func Test(t *testing.T) {
	...
	terraformOptions := &terraform.Options{
		...
		TerraformDir: "../../_example/on-demand",
		Upgrade: true,
	}
	...
	Arn := strings.Join(terraform.OutputList(t, terraformOptions, "autoscaling_group_arn")," ")

	// Verify we're getting back the outputs we expect
	assert.Contains(t, Arn, "arn:aws:autoscaling")
}